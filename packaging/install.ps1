...
.NOTES
    ...
    WARNING: This installs an untested alpha release (v3.0.0-alpha.8).
#>
...
$assetName = "Nex-setup-3.0.0-alpha.8.exe"
$expectedSha256 = "f971188c699e337ab96b99e613445c3239aebb25c8aff0a428e36dee3ccedbb3"
