...
.NOTES
    ...
    WARNING: This installs an untested alpha release (v3.0.0-alpha.3).
#>
...
$assetName = "Nex-setup-3.0.0-alpha.3.exe"
$expectedSha256 = "dd93639aa4f421e13cb3cd845ba1bde67642463c2ff9d5edd1a0cf827e2c31c6"
